...
echo brew bundle --file $DOT_DIR/Brewfile
...
ln -Ffhs $DOT_DIR/nvim "${XDG_CONFIG_HOME:-$HOME/.config}/nvim"
ln -Ffhs $DOT_DIR/hammerspoon "${HOME}/hammerspoon"
ln -Ffhs $DOT_DIR/bin "${HOME}/.bin"
ln -Ffhs $DOT_DIR/tmux/tmux.conf "${HOME}/.tmux.conf"
ln -Ffhs $DOT_DIR/tmux/tmux.mac.conf "${HOME}/.tmux.env.conf"
